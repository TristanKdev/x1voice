...
Then availability. The agent needs to know what's 86'd right now, which means either polling your POS or receiving push notifications, plus a decision about what to do when that sync is stale. All of it is covered in menu sync deep dive, and none of it is generic — it's rebuilt per POS.
