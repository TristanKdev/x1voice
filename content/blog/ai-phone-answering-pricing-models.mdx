...
Also ask what happens to the price at renewal. A first-year rate that steps up automatically is a normal commercial term, but it belongs in your comparison, not in a footnote. We cover the rest of that ground in contract terms worth pushing back on.
