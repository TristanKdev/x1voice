...
description: "Tokenization is the reason a phone order can be paid for without your restaurant ever holding a card number. What a token is, why it matters for scope and risk, and the questions that separate a real answer from a hand-wave."
