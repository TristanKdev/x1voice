...
Every article about restaurant phone systems opens with some version of "restaurants miss X% of calls." The number changes depending on who's selling what. The more useful exercise — and the one that actually tells you whether this is a real problem for your restaurant specifically — is measuring your own.
...
A simple tally sheet by the phone works fine. The goal isn't precision to the decimal point — it's a real number instead of a guess.
...
Most restaurants find the bulk of their missed calls cluster in two or three windows a week, not spread evenly — which matters, because it tells you whether the fix needs to cover all hours or just a few.
