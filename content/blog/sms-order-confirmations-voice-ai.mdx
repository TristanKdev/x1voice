---
title: "SMS Order Confirmations for Restaurant Phone Orders"
description: "A text after a phone order gives the customer something to check instead of calling back. What belongs in that message, what to skip, and how to judge an agent."
