...
description: "Phone orders sit awkwardly between counter service and delivery when it comes to tips. Here's how restaurants handle the prompt, the awkwardness, and the rules worth confirming with an advisor."
