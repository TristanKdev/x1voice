...
const PRICING_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Included minutes run from 750 on Starter up to 6,000 on Business. Once you pass them, extra minutes are billed at your plan's per-minute rate, $0.15 on Starter, $0.12 on Professional, $0.10 on Business, so a heavier plan lowers your overage rate. If you're consistently running over, we'll help you move to a plan sized for your call volume.",
  },
  {
